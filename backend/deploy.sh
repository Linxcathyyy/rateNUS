...
scp -i "path to ratenus key pair.pem" execute_commands_on_ec2.sh ec2-user@ec2-3-142-45-139.us-east-2.compute.amazonaws.com:/home/ec2-user
echo "Copied latest 'execute_commands_on_ec2.sh' file from local machine to ec2 instance"

scp -i "path to ratenus key pair.pem" build/libs/backend-0.0.1-SNAPSHOT.jar ec2-user@ec2-3-142-45-139.us-east-2.compute.amazonaws.com:/home/ec2-user
...
ssh -i "path to ratenus key pair.pem" ec2-user@ec2-3-142-45-139.us-east-2.compute.amazonaws.com ./execute_commands_on_ec2.sh
